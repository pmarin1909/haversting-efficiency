...
\usepackage[none]{hyphenat} % para evitar que se dividan las palabras
\usepackage{caption}
\captionsetup{width=\textwidth} % o más grande si es necesario
...
% SI VAS A USAR GLOSARIO DESCOMENTAR ESTO
\usepackage{glossaries}    %Glosario
\makeglossaries
\input{glosario.tex} % definiciones externas
...
% SI VAS A USAR BIBLIOGRAFIA DESCOMENTA ESTO
